  ...
  <div class="container ps-2 p-4">
     <div class="row">
        <div class="col-sm-8 col-md-6 ps-0">
           <h4 class="text-white ps-1 m-0 wpe_brand_header_title"><?php _e( "WP Extended - Plugin & Theme Rollback", WP_EXTENDED_TEXT_DOMAIN ); ?></h4>
        </div>
...
<div class="container-fluid wp_brand_sub_header">
   <div class="container">
     <div class="row align-items-baseline">
       <div class="col-lg-6 px-1"><p class="wp_brand_sub_header_left"><a href="<?php echo get_admin_url(); ?>admin.php?page=wp-extended" class="wp_brand_sub_header_back_link">&#x2190; <?php _e('Back to Modules', WP_EXTENDED_TEXT_DOMAIN ); ?></a> | <a href="#" class="wp_brand_sub_header_back_document"><?php _e('Documentation', WP_EXTENDED_TEXT_DOMAIN);?></a></p></div>
   
     </div>
   </div>
</div> 

<div class="container wpext-container wp-extend-rollback-manager" id="wp-extended-app">
   <div class="row">
      <div class="col-lg-12 gx-5 mb-3 bg-white p-0 rounded-2"> 
            <div class="container border border-dark rounded-2 p-3">
               <div class="hstack gap-3 p-3 mx-3 mt-4" style="background: #F9FAFB;">
   ...
   <div class="container bg-white text-dark p-3 gap-3 mb-3">
      <form name="check_for_rollbacks" class="rollback-form" action="<?php echo admin_url( '/admin.php' ); ?>">
         ...
         <div class="wpext-submit-wrap">
            <button type="button" class="wp-ext-btn-prim wpextended_popup " data-coreui-toggle="modal" data-coreui-target="#exampleModal" 
               id="rollback_btn"><?php _e('Rollback', WP_EXTENDED_TEXT_DOMAIN); ?></button>
            <input type="button" value="<?php _e( 'Back', WP_EXTENDED_TEXT_DOMAIN ); ?>" class="wpext-return-module wp-ext-btn-sec me-2" onclick="location.href='<?php 
                     ...
                     <div id="wpext-modal-confirm" class="">
                        ...
                        <div class="wpext-modal-inner px-3">
                           ...
                           <div class="wpext-error">
                              <p><?php _e( '<strong>Notice:</strong> We strongly recommend you create a complete backup, before you take this action.', WP_EXTENDED_TEXT_DOMAIN ); ?></p>
                           </div>
